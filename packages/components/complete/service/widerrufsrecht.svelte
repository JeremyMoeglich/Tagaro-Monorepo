<script lang="ts">
	import { city } from 'open_constants';
</script>
...
<div class="text_block">
	...
	<p>
		...
		Großer Sandweg 32, {city}, E-Mail info(at)tagaro.de, Telefon (02381) 9874699, Fax (0321) 2111
		6558) mittels einer eindeutigen Erklärung (z. B. ein mit der Post versandter Brief, Telefax oder
	...
	<p>
		...
		an dem Sie uns über den Widerruf dieses Vertrags unterrichten, an uns oder bei Sky Abonnements
		an Sky Deutschland, 22033 Hamburg) zurückzusenden oder zu übergeben. Die Frist ist gewahrt, wenn
