<script lang="ts">
	import { city, email } from 'open_constants';
</script>
...
<div class="text_block">
	...
	<p>
		...
		GmbH & Co. KG: <br />
		<a rel="noreferrer" href="https://www.sky.de/datenschutz" target="_blank"
			>https://www.sky.de/datenschutz</a
		>
		<br />
	</p>
	<div>
		...
		<p>
			...
			Datenschutz-Grundverordnung (DSGVO) ist die TAGARO Medienshop - Möglich & Möglich GbR, Großer
			Sandweg 32, {city}, Deutschland, Tel.: 02381-9874699, Fax: 0321 21116558, E-Mail: {email}. Der
			für die Verarbeitung von personenbezogenen Daten Verantwortliche ist diejenige natürliche oder
			juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der
			Verarbeitung von personenbezogenen Daten entscheidet.
		</p>
		<p>
			1.3 Diese Website nutzt aus Sicherheitsgründen und zum Schutz der Übertragung personenbezogene
			Daten und anderer vertraulicher Inhalte (z.B. Bestellungen im Aboformular oder Anfragen an den
			Verantwortlichen) eine SSL-Verschlüsselung. Sie können eine verschlüsselte Verbindung an der
	...
	<div>
		...
		<p>
			...
			sich um kleine Textdateien, die auf Ihrem Endgerät abgelegt werden. Einige der von uns
			verwendeten Cookies werden nach dem Ende der Browser-Sitzung, also nach Schließen Ihres
			Browsers, wieder gelöscht (sog. Sitzungs-Cookies). Andere Cookies verbleiben auf Ihrem
			Endgerät und ermöglichen uns oder unseren Partnerunternehmen (Cookies von Drittanbietern),
			Ihren Browser beim nächsten Besuch wiederzuerkennen (persistente Cookies). Werden Cookies
			gesetzt, erheben und verarbeiten diese im individuellen Umfang bestimmte Nutzerinformationen
			wie Browser- und Standortdaten sowie IP-Adresswerte. Persistente Cookies werden automatisiert
		...
		<p>
			...
			vereinfachen (z.B. Merken des Inhalts eines vorausgefüllten Aboformulars für einen späteren
			Besuch auf der Website). Sofern durch einzelne von uns implementierte Cookies auch
			personenbezogene Daten verarbeitet werden, erfolgt die Verarbeitung gemäß Art. 6 Abs. 1 lit. b
			DSGVO entweder zur Durchführung des Vertrages oder gemäß Art. 6 Abs. 1 lit. f DSGVO zur
			Wahrung unserer berechtigten Interessen an der bestmöglichen Funktionalität der Website sowie
			einer kundenfreundlichen und effektiven Ausgestaltung des Seitenbesuchs.
		</p>
		<p>
			Wir arbeiten unter Umständen mit Werbepartnern zusammen, die uns helfen, unser Internetangebot
			...
			den Einsatz derartiger Cookies und den Umfang der jeweils erhobenen Informationen innerhalb
		...
		<p>
			...
			Cookies für bestimmte Fälle oder generell ausschließen können. Jeder Browser unterscheidet
			sich in der Art, wie er die Cookie-Einstellungen verwaltet. Diese ist in dem Hilfemenü jedes
	...
	<div>
		...
		<p>
			...
			technische Administration gespeichert und verwendet. Rechtsgrundlage für die Verarbeitung der
			Daten ist unser berechtigtes Interesse an der Beantwortung Ihres Anliegens gemäß Art. 6 Abs. 1
			lit. f DSGVO. Zielt Ihre Kontaktierung auf den Abschluss eines Vertrages ab, so ist
			zusätzliche Rechtsgrundlage für die Verarbeitung Art. 6 Abs. 1 lit. b DSGVO. Ihre Daten werden
			nach abschließender Bearbeitung Ihrer Anfrage gelöscht, dies ist der Fall, wenn sich aus den
	...
	<div>
		...
		<p>
			5.2 Zur Erfüllung unserer vertraglichen Pflichten unseren Kunden gegenüber arbeiten wir mit
			externen Versandpartnern zusammen. Wir geben Ihren Namen sowie Ihre Lieferadresse
			ausschließlich zu Zwecken der Warenlieferung Art. 6 Abs. 1 lit. b DSGVO an einen von uns
			ausgewählten Versandpartner weiter.
		</p>
		<p>5.3 Weitergabe personenbezogener Daten an Versanddienstleister</p>
		<p>
			- DHL <br />
			Erfolgt die Zustellung der Ware durch den Transportdienstleister DHL (Deutsche Post AG, Charles-de-Gaulle-Straße
			20, 53113 Bonn), so geben wir Ihre E-Mail-Adresse gemäß Art. 6 Abs. 1 lit. a DSGVO vor der Zustellung
			der Ware zum Zwecke der Abstimmung eines Liefertermins bzw. zur Lieferankündigung an DHL weiter,
			sofern Sie hierfür im Bestellprozess Ihre ausdrückliche Einwilligung erteilt haben. Anderenfalls
			geben wir zum Zwecke der Zustellung gemäß Art. 6 Abs. 1 lit. b DSGVO nur den Namen des Empfängers
			und die Lieferadresse an DHL weiter. Die Weitergabe erfolgt nur, soweit dies für die Warenlieferung
			erforderlich ist. In diesem Fall ist eine vorherige Abstimmung des Liefertermins mit DHL bzw. die
			Lieferankündigung nicht möglich. Die Einwilligung kann jederzeit mit Wirkung für die Zukunft gegenüber
			dem oben bezeichneten Verantwortlichen oder gegenüber dem Transportdienstleister DHL widerrufen
			werden.
		</p>
		<p>
			...
			widerrufen. <br />
			Für den Fall, dass eine Löschung aus rechtlichen, technischen oder organisatorischen Gründen nicht
			oder nur mit unverhältnismäßigem Aufwand möglich ist, wird die Verarbeitung Ihrer Daten eingeschränkt.
		</p>
		<p>
			5.5. Weitergabe personenbezogener Daten an die Innovero Software Solutions B.V. <br />
			<br />
			Im Rahmen und zur Durchführung der Vertragserstellung eines Sky Abonnements, werden Abodaten eines
			Kunden (Kaufgegenstand, Name, Postanschrift, E-Mail-Adresse, Lieferanschrift, Bezahlweise und Bankdaten)
			über das Formdesk Formular-System von Innovero (Innovero Software Solutions B.V., Rijksstraatweg
			713 zu Wassenaar, Kamer van Koophandel-Nummer 27157981) aufgenommen. <br />
			...
			Ein entsprechender Vertrag liegt intern vor und kann bei rechtlicher Notwendigkeit vorgelegt werden.
		</p>
	</div>
	<div>
		...
		<p>
			...
			berechtigten Interessen an einer optimalen Vermarktung unseres Angebots auf der eigenen
			Webseite. Bei dem Aufruf des Trustami Vertrauenssiegels speichert der Webserver automatisch
			Daten (Zugriffsdaten) in Form eines Server-Logfiles, das z.B. Datum und Uhrzeit des Abrufs,
			Ihre IP-Adresse in gekürzter Form und den anfragenden Provider enthält. Diese Zugriffsdaten
			werden nicht ausgewertet und spätestens sieben Tagen nach Ende Ihres Seitenbesuchs automatisch
			überschrieben. Das Trustami Vertrauenssiegel und die damit beworbenen Dienstleistungen sind
			ein Angebot der Trustami GmbH, Friedrich-Wilhelm Str.68, 12103 Berlin.
		</p>
	</div>
	<div>
		...
		<p>
			...
			Parkway, Mountain View, CA 94043, USA ("Google"). Google Analytics verwendet sog. "Cookies", Textdateien,
			die auf Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der Website durch
			Sie ermöglichen. Die durch das Cookie erzeugten Informationen über Ihre Benutzung dieser Website
			(einschließlich der gekürzten IP-Adresse) werden in der Regel an einen Server von Google in den
			...
			zuvor gekürzt. Nur in Ausnahmefällen wird die volle IP-Adresse an einen Server von Google in den
			USA übertragen und dort gekürzt. In diesen Ausnahmefällen erfolgt diese Verarbeitung gemäß Art.
			6 Abs. 1 lit. f DSGVO auf Grundlage unseres berechtigten Interesses an der statistischen Analyse
			des Nutzerverhaltens zu Optimierungs- und Marketingzwecken.<br />
			In unserem Auftrag wird Google diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten,
			um Reports über die Websiteaktivitäten zusammenzustellen und um weitere mit der Websitenutzung
			und der Internetnutzung verbundene Dienstleistungen uns gegenüber zu erbringen. Die im Rahmen von
			...
			Alternativ zum Browser-Plugin oder innerhalb von Browsern auf mobilen Geräten klicken Sie bitte
			auf den folgenden Link, um ein Opt-Out-Cookie zu setzen, der die Erfassung durch Google Analytics
			innerhalb dieser Website zukünftig verhindert (dieses Opt-Out-Cookie funktioniert nur in diesem
			Browser und nur für diese Domain, löschen Sie Ihre Cookies in diesem Browser, müssen Sie diesen
			...
			<a href="https://support.google.com/analytics/answer/6004245?hl=de"
				>support.google.com/analytics/answer/6004245</a
			>
		</p>
		<br />
	</div>
	<div>
		...
		<ul>
			...
			<li>
				Recht auf Unterrichtung gemäß Art. 19 DSGVO: Haben Sie das Recht auf Berichtigung, Löschung
			...
			<li>
				Recht auf Beschwerde gemäß Art. 77 DSGVO: Wenn Sie der Ansicht sind, dass die Verarbeitung
	...
	<div>
		...
		<p>
			...
			- Die Sky Deutschland Fernsehen GmbH & Co. KG informiert zu den Regelfristen für die Löschung
			der Daten inhouse<br />

			Nutzungsdaten zu Abrechnungszwecken:<br />

			Werden gelöscht mit einer Frist von derzeit 80 Tagen<br />

			Bestandsdaten nach Widerspruch:<br />
			werden sofort gelöscht, sofern nicht gesetzliche Aufbewahrungspflichten und -fristen dem entgegenstehen<br
			/>

			Sofern eine Löschung aus technischen oder organisatorischen Gründen nicht oder nur mit
			unverhältnismäßigem Aufwand möglich ist, werden die Daten zur weiteren Verarbeitung oder
			Nutzung gesperrt.<br />
		</p>
	</div>
	<div>
		...
		<p>
			...
			MIT WIRKUNG FÜR DIE ZUKUNFT EINZULEGEN.<br />
			...
			ZUM ZWECKE DERARTIGER WERBUNG EINZULEGEN. SIE KÖNNEN DEN WIDERSPRUCH WIE OBEN BESCHRIEBEN AUSÜBEN.<br
			/>
			MACHEN SIE VON IHREM WIDERSPRUCHSRECHT GEBRAUCH, BEENDEN WIR DIE VERARBEITUNG DER BETROFFENEN DATEN
