<script lang="ts">
	// #region [c3] Imports
	import { cable_receive_assets, receive_assets } from 'asset_library/assets/receive_type';
	import { zubuchoptionen_assets } from 'asset_library/assets/zubuchoptionen';
	...
	import MultiBoxSelector from 'components/elements/interactive/box_selector/multi_box_selector.svelte';
