...
<ExpandableBox title={'*Vertragsinformationen'}>
	<span slot="main_text">
		<div>
			...
			<ul>
				<li>
					- Sky Entertainment + Sky Sport + Sky Cinema + Sky Fußball-Bundesliga für mtl. € 42,50
				</li>
				<li>
					- Oder Sky Ultimate TV mit Entertainment inkl. Netflix + Sky Sport + Sky Cinema + Sky
					Fußball-Bundesliga für mtl. € 48,00
				</li>
			</ul>
			<p>
		...
		<div>
			<h3>TV-Gerät</h3>
			<p>
				Bei Buchung hat der Kunde Anspruch auf einen Gutschein von Sky, welcher die rabattierte
				Kaufoption für ein 32 Zoll Toshiba Full HD LED Smart TV, schwarz umfasst und im Karcher AG
				Online-Shop für den Preis von € 1 bestellt werden kann. Das TV-Gerät hat einen UVP von €
				369. Der Kaufpreis wird bei der ersten Sky Abonnementabrechnung verrechnet, sodass sich die
				erste Sky Abonnement-Monatsgebühr um einen Euro reduziert. Abwicklung und Versand des
				TV-Geräts ist kostenfrei und erfolgt alleinig über die KARCHER AG. Vertragspartner für den
				Kauf wird die KARCHER AG. Der Gutschein wird nach Ablauf der Widerrufsfrist und positiver
				Bonitätsprüfung sowie des ersten positiven Zahlungseingangs bei Sky, per E-Mail in Form
				eines digitalen Gutscheincodes ca. 6-8 Wochen nach Abonnementvertragsabschluss an den Kunden
				versendet. Die Versendung des Gutscheins erfolgt durch Sky. Die Einlösung des Gutscheins ist
				bis zum 31.03.2022 befristet.
			</p>
		</div>
		<div>
			<h3>Alternativ-Angebot zum TV-Gutschein - Amazon Gutschein im Wert von € 150:</h3>
			<p>
				Wenn Sie keinen TV-Gutschein wünschen, gibt es alternativ bei uns in der Abwicklung auch
				einen Amazon Gutschein im Wert von € 150 zu ihrem Komplett-Abonnement dazu. Der Gutschein
				wird nach Ablauf der Widerrufsfrist und positiver Bonitätsprüfung sowie des ersten positiven
				Zahlungseingangs bei Sky, per Mail in Form eines digitalen Gutscheincodes ca. 6-8 Wochen
				nach Abonnementvertragsabschluss per E-Mail versendet. Die Versendung des Gutscheins erfolgt
				durch Sky. Die Einlösung des Gutscheins ist bis 31.03.2022 nach Ausgabe des Gutscheins
				einlösbar.
			</p>
		</div>
		<div>
