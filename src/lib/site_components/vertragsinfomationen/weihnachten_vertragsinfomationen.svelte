	...
	<span slot="main_text">
		...
		<!-- <div>
			...
			<p>
				...
				Paket für 6 Monate und bei Buchung von mindestens Sky Entertainment + Sky Fußball-Bundesliga
				+ Sky Cinema, für 12 Monate ohne Aufpreis inklusive. Die Freischaltung endet automatisch.
			</p>
		</div>
		<div>
			<h3>Cashback für das Sport Paket von Sky:</h3>
			<p>
				Bei der Buchung von mindestens Sky Entertainment + Sky Fußball-Bundesliga + Sky Sport wird
				eine Gutschrift in Höhe von € 33 bzw. bei Buchung von mindestens Sky Entertainment + Sky
				Fußball-Bundesliga + Sky Sport + Cinema eine Gutschrift in Höhe von € 66 auf den monatlichen
				Abonnement Preis gewährt. Die Gutschrift erfolgt mit jeweils € 5,50 (für 6 bzw. 12 Monate)
