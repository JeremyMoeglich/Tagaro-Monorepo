...
<div>
	<div class="alignment">
		...
		<p>
			...
			Webseite www.tagaro.de elektronisch ausfüllen und übermitteln. Machen Sie von dieser
			Möglichkeit Gebrauch, so werden wir Ihnen unverzüglich (z. B. per E-Mail) eine Bestätigung
		...
		<p>
			...
			Tag, an dem Sie uns über den Widerruf dieses Vertrags unterrichten, an uns oder bei Sky
			Abonnements an Sky Deutschland, 22033 Hamburg) zurückzusenden oder zu übergeben. Die Frist ist
