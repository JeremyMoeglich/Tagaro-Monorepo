...
const package_prices: Record<package_id, PackagePrice> = {
...
const base_packages: ReadonlyArray<package_id> = ['entertainment', 'entertainmentplus'];
const premiumpackages: ReadonlyArray<package_id> = ['cinema', 'sport', 'bundesliga'];
...
export function get_price(packages: Array<package_id>): PackagePrice {
	return {
